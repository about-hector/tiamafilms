...
import StoryScrollWrapper from '@/components/v1/StoryScrollWrapper'
import MasonryStoryModule from '@/components/v1/MasonryStoryModule'
import RomanticGardenWedding from '@/components/v1/stories/RomanticGardenWedding'
import ModernCityWedding from '@/components/v1/stories/ModernCityWedding'
...
export default function V1Page() {
  ...
  // Create a dummy scroll progress for story components
